...
public class DeliverRequest30MessageCodec implements IMessageCodec<DeliverRequest> {
    ...
    public DeliverRequest decode(ChannelHandlerContext ctx, int sequenceId, ByteBuf in) throws Exception {
        ...
        msg.setSrcTerminalId(StringUtils.readString(in, 32, StandardCharsets.US_ASCII));
        short srcTerminalType = in.readByte();
        ...
        if (registeredDelivery == 0) {
            ...
            report.setDestTerminalId(StringUtils.readString(in, 32, StandardCharsets.US_ASCII));
    ...
    public void encode(ChannelHandlerContext ctx, DeliverRequest msg, ByteBuf out) throws Exception {
        ...
        out.writeBytes(StringUtils.toBytes(msg.getSrcTerminalId(), 32));
        ...
        if (msg.getReport() == null) {
            ...
            out.writeBytes(StringUtils.toBytes(report.getDestTerminalId(), 32));
