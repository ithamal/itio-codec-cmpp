...
public class DeliverRequest30MessageCodec implements ICmppCodec<DeliverRequest> {
    ...
    public DeliverRequest decode(ChannelHandlerContext ctx, int sequenceId, ByteBuf byteBuf) throws Exception {
        ...
        msg.setSrcTerminalId(StringUtils.readString(byteBuf, 32, StandardCharsets.US_ASCII));
        short srcTerminalType = byteBuf.readByte();
        ...
        if (registeredDelivery == 0) {
            ...
            report.setDestTerminalId(StringUtils.readString(byteBuf, 32, StandardCharsets.US_ASCII));
    ...
    public void encode(ChannelHandlerContext ctx, DeliverRequest msg, ByteBuf byteBuf) throws Exception {
        ...
        byteBuf.writeBytes(StringUtils.toBytes(msg.getSrcTerminalId(), 32));
        ...
        if (msg.getReport() == null) {
            ...
            byteBuf.writeBytes(StringUtils.toBytes(report.getDestTerminalId(), 32));
